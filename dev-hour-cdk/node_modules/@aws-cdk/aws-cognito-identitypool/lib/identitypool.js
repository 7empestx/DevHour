...
class IdentityPoolProviderUrl {
    ...
    value) {
        ...
        this.value = value;
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_IdentityPoolProviderType(type);
        }
        catch (error) {
...
IdentityPoolProviderUrl[_a] = { fqn: "@aws-cdk/aws-cognito-identitypool.IdentityPoolProviderUrl", version: "1.173.0" };
...
class IdentityPool extends core_1.Resource {
    constructor(scope, id, props = {}) {
        ...
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_IdentityPoolProps(props);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
    ...
    addUserPoolAuthentication(userPool) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_IUserPoolAuthenticationProvider(userPool);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
    ...
    */
    addRoleMappings(...roleMappings) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_IdentityPoolRoleMapping(roleMappings);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
