...
class UserPoolAuthenticationProvider {
    constructor(props) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_UserPoolAuthenticationProviderProps(props);
        }
        catch (error) {
    ...
    bind(scope, identityPool, _options) {
        try {
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_IIdentityPool(identityPool);
            jsiiDeprecationWarnings._aws_cdk_aws_cognito_identitypool_UserPoolAuthenticationProviderBindOptions(_options);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
